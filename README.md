...
| Name | Type |
|------|------|
| [null_resource.k8s_node_queries](https://registry.terraform.io/providers/hashicorp/null/latest/docs/resources/resource) | resource |
...
| <a name="output_cpu_arch_debug"></a> [cpu\_arch\_debug](#output\_cpu\_arch\_debug) | CPU architecture debugging information for mixed clusters |
| <a name="output_debug_storage_config"></a> [debug\_storage\_config](#output\_debug\_storage\_config) | Debug information for storage configuration validation |
...
| <a name="output_storage_debug"></a> [storage\_debug](#output\_storage\_debug) | Detailed storage debugging information for troubleshooting |
<!-- END_TF_DOCS -->
