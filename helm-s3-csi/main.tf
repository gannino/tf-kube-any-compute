# ============================================================================
# S3 CSI DRIVER - Kubernetes Resources
# ============================================================================
...
# Secret is managed by Helm chart - not created in Terraform (create_secret = false)
# StorageClass is managed by Helm chart - not created in Terraform
# This avoids ownership conflicts between Terraform and Helm

# Deploy S3 CSI driver via Helm from GitHub repository
resource "helm_release" "this" {
  ...
  values = [
    templatefile("${path.module}/templates/s3-csi-values.yaml.tpl", local.template_values)
  ]
