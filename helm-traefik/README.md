...
| <a name="input_enable_load_balancer_class"></a> [enable\_load\_balancer\_class](#input\_enable\_load\_balancer\_class) | Enable load balancer class for Traefik service | `bool` | `false` | no |
...
| <a name="input_load_balancer_class"></a> [load\_balancer\_class](#input\_load\_balancer\_class) | Load balancer class for Traefik service | `string` | `"metallb"` | no |
